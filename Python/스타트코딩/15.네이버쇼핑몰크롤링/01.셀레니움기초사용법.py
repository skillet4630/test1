...
# 브라우저 생성
browser = webdriver.Chrome() #현재 버전에선 크롬브라우저를 따로 다운받지 않아도 사용가능함

# 브라우저 열기
browser.get('https://www.naver.com')

# 쇼핑 메뉴 클릭하기
browser.find_element(By.CSS_SELECTOR, ".service_icon.type_shopping").click() # CSS 선택지로 태그를 선택하는 명령어 # 클릭을 싱행하는 명령어
time.sleep(2)
